          ...
          child: Column(
            children: [
              ...
              !controller.showsearchbar
                  ...
                  : const SizedBox(),
              SB.h(30),
              userController.currentUser.value.friends!.isEmpty? const Center(child: Text('No Friends', style: TextStyle(color: Colors.white54, fontSize: 30),),): Expanded(
                child:  FirebaseAnimatedList(
                  ...
                  itemBuilder: (context, snapshot, animation, index) {
                    ...
                    else if (userController.currentUser.value.friends!
